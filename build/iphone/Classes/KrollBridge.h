...
@interface Assign4_353Object : KrollCoverageObject {
#else
@interface Assign4_353Object : KrollObject {
#endif
@private
...
extern NSString * Assign4_353$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Assign4_353Object *_assign4_353;
    KrollObject* console;
	BOOL shutdown;
