...
//@interface Assign4_353Object : NSObject
//@end

@interface Assign4_353Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Assign4_353Object class]])
		{
			for (NSString *key in [[(Assign4_353Object*)o modules] allKeys])
			{
