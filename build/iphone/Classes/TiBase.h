...
// in simulator we redefine to format for Assign4_353 Developer console
...
{\
	NSString * exceptionName = [@"org.assign4_353." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.assign4_353";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAssign4_353NativeItemNone = -1, 
	UIAssign4_353NativeItemSpinner = -2,
	UIAssign4_353NativeItemProgressBar = -3,
	
	UIAssign4_353NativeItemSlider = -4,
	UIAssign4_353NativeItemSwitch = -5,
	UIAssign4_353NativeItemMultiButton = -6,
	UIAssign4_353NativeItemSegmented = -7,
	
	UIAssign4_353NativeItemTextView = -8,
	UIAssign4_353NativeItemTextField = -9,
	UIAssign4_353NativeItemSearchBar = -10,
	
	UIAssign4_353NativeItemPicker = -11,
	UIAssign4_353NativeItemDatePicker = -12,
	
	UIAssign4_353NativeItemInfoLight = -13,
	UIAssign4_353NativeItemInfoDark = -14,
	
	UIAssign4_353NativeItemDisclosure = -15,
	
	UIAssign4_353NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Assign4_353 instances of
