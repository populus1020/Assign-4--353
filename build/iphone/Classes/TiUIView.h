...
/**
 Base class for all Assign4_353 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Assign4_353 view hierarchy (such as wrapped iOS UIViews) was touched.
