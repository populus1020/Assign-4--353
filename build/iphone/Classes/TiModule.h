...
/**
 The base class for all Assign4_353 modules
 */
...
/**
 Assign4_353 Platform calls this method on startup.
 */
-(void)startup;

/**
 Assign4_353 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Assign4_353 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Assign4_353 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Assign4_353 Platform calls this method on resume.
 @param sender The sender of the event.
 */
